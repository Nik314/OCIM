...
def apply(ocel,ocpn,contexts=None,bindings=None, special_activities=[]):
    '''
    ...
    en_m, total_timed =  replay_context.enabled_model_activities_multiprocessing(contexts, bindings, ocpn, object_types)
